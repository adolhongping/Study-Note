...
5. #### 赋值运算符重载
    ...
    ​	代码链接：https://blog.csdn.net/weixin_45233461/article/details/106659905
...
7. #### 关系运算符重载
    ...
    代码链接：https://blog.csdn.net/weixin_45233461/article/details/106694361

    1. 自定义数据类型 不会内部作比较 比较	 == 和 ！=
    2. 所以要重载==和！=

8. #### 函数调用运算符的重载

    代码链接：https://blog.csdn.net/weixin_45233461/article/details/106694538

    1. （）仿函数 利用对象调用，看似像函数调用
    2. Myadd() 匿名对象  
